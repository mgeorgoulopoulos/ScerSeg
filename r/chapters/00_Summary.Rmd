...
* We notice the bipolar appearance of coexpression groups and thus divide the genome in 3+1 continents: Eurasia, America, Antarctica and Ocean.
* Eurasia in the larger one, sitting on one side of the nucleus.
* America is the second larger, sitting on the opposite side.
* Both Eurasia and America encompass part of the Hat.
* They are separated by the Ocean cluster, which splits the genome in half. Even the Hat has its own schism.
...
* Ocean (insulator) has a lower average coexpression score than random.

### Gene ontology enrichment

* The Ocean (coexpression insulator) is rich in genes having to do with "Metabolic pathways" (Padj: 2%)
